...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('C:/Users/divya/OneDrive/Desktop/DJ/Hackathon/AAA/Sign-Language-To-Text-and-Speech-Conversion/cnn8grps_rad1_model.h5')
        self.speak_engine=pyttsx3.init()
        self.speak_engine.setProperty("rate",1000)
        ...
        self.speak.config(text="Send for processing", font=("Courier", 20), wraplength=100, command=self.send_fun)
        ...
        try:
            ...
            if hands:
                ...
                try:
                    ...
                    white = cv2.imread("C:/Users/divya/OneDrive/Desktop/DJ/Hackathon/AAA/Sign-Language-To-Text-and-Speech-Conversion/white.jpg")
    ...
    def send_fun(self):
        print('processed output: '+self.str)
